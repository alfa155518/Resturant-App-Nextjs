...
export default function ChefRecommendations({styles,motion}) {
  return (
    ...
    <SectionName title={"Chef's Recommendations"} description={"Handpicked selections from our master chef"}/>
    ...
    >
      <div className={styles.chefProfile}>
        ...
        <h3>Chef Michael</h3>
        <p>Executive Chef</p>
        <p className={styles.chefQuote}>"I recommend trying our signature Grilled Salmon with a side of seasonal vegetables. The fresh ingredients and perfect seasoning make it a truly unforgettable experience."</p>
      </div>
      ...
      <div className={styles.weeklySpecial}>
        ...
        <div className={styles.specialDish}>
          ...
          <div className={styles.specialDishInfo}>
            ...
            <p>Creamy Arborio rice cooked with wild mushrooms, finished with truffle oil and parmesan</p>
